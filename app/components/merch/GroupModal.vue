      ...
      <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <form @submit.prevent="handleSubmit" class="p-6 space-y-6">
          ...
          <div>
            ...
            <p class="text-xs text-gray-500 mb-3">Select which photo should be used as the cover image for this product</p>
          ...
          <div class="bg-gray-50 rounded-lg p-4">
            <p class="text-sm text-gray-600">
              ...
              <span class="font-medium">{{ selectedPhotos.length }}</span> photo{{ selectedPhotos.length !== 1 ? 's' : '' }} will be attached to this product
            </p>
          </div>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const normalizedName = formData.title.trim();
    ...
    // Update all photos to link them to the product
    ...
    error.value = err.message || 'Failed to create product. Please try again.';
  } finally {
    saving.value = false;
  }
};
